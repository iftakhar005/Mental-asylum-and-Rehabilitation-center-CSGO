...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $staff_id = 'CHF-' . date('Ymd') . '-' . rand(1000, 9999);
    // $email = generateEmail($firstName, $lastName, 'chief-staff'); // Removed auto-generation
    ...
    try {
        ...
        $sql = "INSERT INTO staff (staff_id, full_name, role, dob, gender, address, experience, phone, password_hash, email, user_id, temp_password, two_factor_enabled) VALUES ('$staff_id', '$full_name', 'chief-staff', '$dob', '$gender', '$address', '$experience', '$phone', '$hashed_password', '$email', $user_id, '$temp_password', $enable_2fa)";
...
<head>
    ...
    <title>Add Chief Staff - MindCare</title>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Add New Chief Staff</h1>
            <p class="page-subtitle">Fill in the details below to add a new chief staff to the system</p>
        </div>
        <?php if ($success_data): ?>
        ...
        <div class="card">
            <form method="POST" action="">
                ...
                <button type="submit" class="btn">
                    <i class="fas fa-user-plus"></i> Add Chief Staff
                </button>
            </form>
        </div>
    </div>
